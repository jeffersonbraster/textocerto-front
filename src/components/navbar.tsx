      ...
      <div className='max-w-7xl mx-auto lg:px-8 px-6'>
        <div className='relative flex h-14 items-center justify-between'>
          <Link
            ...
            <img src='/swear-emoji.png' className='h-6 w-6 mr-1.5' alt="emoji com raiva" />
            Texto Certo API
          </Link>

          {/* placeholder */}
          <div className='hidden sm:block invisible'>Texto Certo API</div>
          ...
          <Link
            href='https://github.com/jeffersonbraster/textocerto-front'
            target='_blank'
